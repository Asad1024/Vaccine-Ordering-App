        ...
        {products.length > 0 && (
          <div className="container-fluid">
            ...
            <div className="product-grid">
              {products.filter(
                (product) =>
                  product.restaurant === "Muffins" && product.type === "fast"
              ).length > 0 && (
              ...
              {products.filter(
                (product) =>
                  product.restaurant === "Muffins" && product.type === "dessert"
              ).length > 0 && (
                <div className="product-type">
              ...
              {products.filter(
                (product) =>
                  product.restaurant === "Muffins" && product.tpye === "snacks"
              ).length > 0 && (
                <div className="product-type">
